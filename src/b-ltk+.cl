...
#|
 ...
 2006  Peter Herth <herth@peter-herth.de>
...
;defined functions rather than to the global function definitions of the same name. 
...
(let* (
  (defs    (process-layout layout nil))
